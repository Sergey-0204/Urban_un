# Работа со словарями:
my_dict = {'Sergey': 1985,
           'Oleg': 1984}  # Создаём переменную и присваеваем ей словарь из нескольких пар (ключ-значение)
...
my_set.add(55), my_set.add(True)  # добавляем два элемента
my_set.remove(9)  # Удаляем один элемент из множества (можно использовать метод discard, тоже самое)
